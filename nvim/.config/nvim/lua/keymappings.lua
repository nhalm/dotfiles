...
local keymappings = {
  ...
  normal_mode = {
    ...
    ["gb"] = {"<Cmd>BufferLinePick<CR>", {noremap = false, silent = true}},
    ["<leader>1"] = {"<Cmd>BufferLineGoToBuffer 1<CR>", {noremap = false, silent = true}},
    ["<leader>2"] = {"<Cmd>BufferLineGoToBuffer 2<CR>", {noremap = false, silent = true}},
    ["<leader>3"] = {"<Cmd>BufferLineGoToBuffer 3<CR>", {noremap = false, silent = true}},
    ["<leader>4"] = {"<Cmd>BufferLineGoToBuffer 4<CR>", {noremap = false, silent = true}},
    ["<leader>5"] = {"<Cmd>BufferLineGoToBuffer 5<CR>", {noremap = false, silent = true}},
    ["<leader>6"] = {"<Cmd>BufferLineGoToBuffer 6<CR>", {noremap = false, silent = true}},
    ["<leader>7"] = {"<Cmd>BufferLineGoToBuffer 7<CR>", {noremap = false, silent = true}},
    ["<leader>8"] = {"<Cmd>BufferLineGoToBuffer 8<CR>", {noremap = false, silent = true}},
    ["<leader>9"] = {"<Cmd>BufferLineGoToBuffer 9<CR>", {noremap = false, silent = true}},
    -- [";"] = ":"
  },
  visual_mode = {
    ["<"] = "<gv",
