...
- _ALWAYS_ use idiomatic Go conventions
- Prefer project structure as described at https://github.com/golang-standards/project-layout
...
- Preference values over references
- Always use values between application layers, e.g. API, Serivce, Data
...
- Use github.com/nhalm/skimatik for application structure and data integration
...
- Prefer github.com/nhalm/pgxkit for connection management
...
- Structured single-line context logging with slog
